...
public class ReplaceElementsWithGreatestElementOnRightSideTest {
    ...
    private ReplaceElementsWithGreatestElementOnRightSide rightSide = new ReplaceElementsWithGreatestElementOnRightSide();
    ...
    public void should_return_new_array_in_other_way() {
        ...
        int[] result = rightSide.replaceElements(arr);
        assertArrayEquals(new int[]{18, 9, 9, 6, 1, -1}, result);
    }
}
